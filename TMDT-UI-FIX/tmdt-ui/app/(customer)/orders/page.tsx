...
import { User, ClipboardList, Wallet, Store, Truck, MessageSquare } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row gap-6">
      ...
      <aside className="w-full md:w-64 space-y-4">
        ...
        <nav className="bg-white rounded-sm shadow-sm py-2">
          ...
          <Link href="/finance"  className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 text-gray-600 text-sm"><Wallet size={18} className="text-blue-500"/> Tài Chính</Link>
        </nav>
      </aside>
