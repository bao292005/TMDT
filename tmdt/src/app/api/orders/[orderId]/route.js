...
import { getCustomerOrderDetail } from "../../../../modules/order/order-service.js";
...
export async function GET(request, { params }) {
  ...
  if (!orderId) {
    return jsonError("ORDER_INVALID_INPUT", "Thiếu orderId để truy cập chi tiết đơn hàng.", correlationId, 400);
  }
